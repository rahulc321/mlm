...
<footer>
        ...
        <div class="container">
            ...
            <ul class="social-icons">
                @foreach ($socials as $social)
                    <li>
                        <a href="{{ @$social->data_values->url }}" title="{{ @$social->data_values->title }}"
                            target="_blank">
    ...
    <div class="footer-bottom">
        <p>@lang('Copyright') {{ date('Y') }} &copy; @lang('All Rights Reserved by') <a
                href="{{ route('home') }}">{{ setting()->get('wcrs_footer_copyright_company_text', '') }}</a>
        </p>
