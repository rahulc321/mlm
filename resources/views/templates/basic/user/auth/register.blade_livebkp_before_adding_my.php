                            ...
                            <div class="common-form-style bg-one create-account">
                                ...
                                <form class="create-account-form row verify-gcaptcha" method="post" action="{{ route('user.register') }}">
                                    ...
                                    @if ($refUser == null)
										...
										<div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="placeid" name="placeid" type="text" value="" autocomplete="off" >
                                            </div>
									...
									<div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">Place ID</label>
                                                <input class="placeid" name="placeid" type="text" value="" >
                                            </div>
                                            <input name="place_id" type="hidden" value="">
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    @endif
									   <div class="col-md-6">
									     <?php $userId = '2RS'.random_int(100000, 999999); ?>
                                        <div class="form-group">
                                            <label class="form-label">User ID</label>
                                            <input class="checkUser" name="username" type="text" value="<?php echo $userId; ?>" readonly>
								   ...
								   <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="userID" name="userID" type="text" value="" >
                                            <small class="text--danger usernameExist"></small>
                                        </div>
                                    </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.success) {
								...
								if(data.position[1]!= null && data.position[2] != null){
									
									alert('Both hand is Available');
									 $('select[name=position]').removeAttr('disabled');
                                $('#position-test').text('');
								  positionDetails = data;
                            updateHand();
								}else if(data.position[1]== null && data.position[2] != null){
									
									alert('Right hand is Available');
									 $('select[name=position]').removeAttr('disabled');
                            ...
                            updateHand();
									...
									// $('select[name=position]').addAttribute('disabled');
									alert('Referral User Posistion Full Please Enter Place ID');
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            updateHand();
									...
									$("#position").prop("disabled", true);
									alert('Place ID Posistion Full Please Enter Other Place ID');
