    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex justify-content-between mb-3 flex-wrap gap-1 text-end">
                <h3 class="dashboard-title">@lang('RSTL Apply Loan Deposit Funds') (Fees: ${{setting('pgrs_rstl_payment_amount_loan_fees')}}) <i class="fas fa-question-circle text-muted text--small" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('Add funds using our system\'s gateway. The deposited amount will be credited to the account balance.')"></i></h3>
                <a class="btn btn--base btn--smd" href="{{ route('user.deposit.history') }}">@lang('Deposit History')</a>
            </div>
            @if(@$loan_application_current_not_approved==0)
                ...
                <div class="card custom--card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select style="display: none" class="form--control form-select" name="gateway" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control form--control" readonly name="amount" type="number" value="{{setting('pgrs_rstl_payment_amount_loan_fees')}}" step="any" autocomplete="off" required>
            ...
            @else
            <h4 class="text--muted"><i class="far fa-frown"></i> {{ __('Sorry! You have already applied for the loan. Please wait for the approval.') }}</h4>
            @endif
        </div>
