...
<div class="row justify-content-center">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control form--control" name="amount" type="number" value="{{ $loan_repayments_emi_amount }}" readonly step="any" autocomplete="off" required>
            ...
            @else
            <h4 class="text--muted"><i class="far fa-frown"></i> {{ __('Sorry! You have already applied for the loan closing. Please wait for the approval.') }}</h4>
            @endif
        </div>
