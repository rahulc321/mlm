    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.users*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.users.emi_defaulters') }} d-none">
                                <a href="{{ route('admin.users.emi_defaulters') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('EMI Defaulters')</span>
                               
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{ menuActive('admin.users.email.unverified') }} d-none">
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.users.mobile.unverified') }} d-none">
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.users.kyc.unverified') }} d-none">
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.users.kyc.pending') }} d-none">
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.users.with.balance') }} d-none">
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.users.paid') }} d-none">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.matching.bonus') }} d-none">
                ...
                <li class="sidebar-menu-item  {{ menuActive(['admin.language.manage', 'admin.language.key']) }} d-none">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.seo') }} d-none">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.kyc.setting') }} d-none">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.frontend.manage.*') }} d-none">
                ...
                <li class="sidebar-menu-item sidebar-dropdown role_content_manager d-none">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.setting.cookie') }} d-none">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.system*', 3) }} d-none">
                ...
                <li class="sidebar-menu-item  {{ menuActive('admin.request.report') }} d-none">
...
@push('style')
    <style>
        <?php
        $admin_user_info = Auth::guard('admin')->user();
        if ($admin_user_info->user_role == 'CONTENT_MANAGER') {
            ?>
            .sidebar__menu li{display:none}
            .sidebar__menu li.role_content_manager{display:block}
            .sidebar__menu li.role_content_manager li{display:block}
            <?php
        }
        ?>
